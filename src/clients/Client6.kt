...
fun main() {
    try {
        ...
        EchoClient6("127.0.0.1", 2000, "echo test", messageWritten, messageRead)
        ...
        Logger.getLogger(EchoClient6::class.java.name).log(Level.SEVERE, null, ex)
    }
}
