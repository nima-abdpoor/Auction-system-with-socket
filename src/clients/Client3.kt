...
fun main() {
    try {
        ...
        EchoClient3("127.0.0.1", 2000, "echo test", messageWritten, messageRead)
        ...
        Logger.getLogger(EchoClient3::class.java.name).log(Level.SEVERE, null, ex)
    }
}
