...
fun main() {
    try {
        ...
        EchoClient5("127.0.0.1", 2000, "echo test", messageWritten, messageRead)
        ...
        Logger.getLogger(EchoClient5::class.java.name).log(Level.SEVERE, null, ex)
    }
}
